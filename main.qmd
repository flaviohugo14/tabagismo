...
## 0, caso contrário.
clean_data$mae_concluiu_ensino_medio <- ifelse(clean_data$escolaridade_mae %in% c(5,6,7), 1, 0)
...
tabelas[["mae_concluiu_ensino_medio"]]
